...
The higher the Republican support in 2016, the higher it in 2020. 
...
It shows the distribution of the data more specifictly.
...
It can show the distribution in each categorical variable more clear and it makes the process of compare each opposite group more clear.
